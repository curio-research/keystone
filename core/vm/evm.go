...
func (evm *EVM) precompile(addr common.Address) (PrecompiledContract, bool) {
	...
	// FIXME: can access state in this object
	// evm.StateDB.GetState(common.Address{}, common.Address{})
