...
var PrecompiledContractsHomestead = map[common.Address]PrecompiledContract{
	...
	// Custom precompiles
	common.BytesToAddress([]byte{5}): &queryPrecompile{},
	common.BytesToAddress([]byte{6}): &getComponentValuePrecompile{},
}
...
// data copy implemented as a native contract.s
