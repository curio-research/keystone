...
// FIXME: does this happen when a tx happens at the end?
...
func (pre *Prestate) Apply(vmConfig vm.Config, chainConfig *params.ChainConfig,
	...
	vmContext := vm.BlockContext{
		...
		// FIXME: can also add more context here for relevant game tx's
	}
...
func MakePreState(db ethdb.Database, accounts core.GenesisAlloc) *state.StateDB {
	println("🫡 MakePreState")
	sdb := state.NewDatabaseWithConfig(db, &trie.Config{Preimages: true})
	statedb, _ := state.New(common.Hash{}, sdb, nil)

	// construct this in-memory database?
	...
	// set temporary variable as part of tx call!
